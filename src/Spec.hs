...
suiteDeTestsDeParteII =
  describe "Parte 2: Temperaturas" $ do
    ...
    describe "haceFrioCelsius" $ do
      ...
      it "Es verdad cuando hacen menos de 8 grados" $ do
        haceFrioCelsius 3 `shouldBe` True
      it "Es verdad cuando hacen 8 grados" $ do
        haceFrioCelsius 8 `shouldBe` True
      it "Es falso cuando hacen más de 8 grados" $ do
        haceFrioCelsius 10 `shouldBe` False

    describe "haceFrioFahrenheit" $ do
      -- Pista: hay 3 casos a testear
      it "Es verdad cuando hacen menos de 46.4 grados" $ do
        haceFrioFahrenheit 40 `shouldBe` True
      it "Es verdad cuando hacen 46.4 grados" $ do
        haceFrioFahrenheit 46.4 `shouldBe` True
      it "Es falso cuando hacen más de 46.4 grados" $ do
